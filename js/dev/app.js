...
var recomendInstance = null;
var compositionInstance = null;
var projectsInstance = null;
var breakpoint = window.matchMedia("(max-width: 767.98px)");
var checkBreakpoint = function() {
	if (breakpoint.matches) {
		if (document.querySelector(".recomend__slider")) {
			if (recomendInstance === null) recomendInstance = new Swiper(".recomend__slider", {
				slidesPerView: 1,
				spaceBetween: 15,
				modules: [Pagination],
				observer: true,
		...
		if (document.querySelector(".composition__slider")) {
			if (compositionInstance === null) compositionInstance = new Swiper(".composition__slider", {
				slidesPerView: 1,
				spaceBetween: 15,
				modules: [Pagination],
				observer: true,
		...
		if (recomendInstance !== null) {
			recomendInstance.destroy(true, true);
			recomendInstance = null;
		}
		if (compositionInstance !== null) {
			compositionInstance.destroy(true, true);
			compositionInstance = null;
		}
	}
};
if (document.querySelector(".projects__slider")) {
	if (projectsInstance === null) projectsInstance = new Swiper(".projects__slider", {
		modules: [
			EffectFade,
			Navigation,
			Pagination
...
function menuInit() {
	...
	const headerMenu = document.querySelectorAll(".header__menu .menu__item--dropdown");
	const overlay = document.getElementById("menuOverlay");
	headerMenu.forEach((desktopDropdown) => {
		...
		function openDesktopMenu() {
			if (desktopDropdown) {
				...
				desktopDropdown.setAttribute("aria-expanded", "true");
...
//#endregion
//#region src/components/custom/headersearch/headersearch.js
...
//#endregion
//#region src/components/custom/cookiebanner/cookiebanner.js
var cookieBanner = document.getElementById("cookieBanner");
var cookieAccept = document.getElementById("cookieAccept");
if (!localStorage.getItem("ad-cookie-accepted")) setTimeout(function() {
	cookieBanner.classList.add("show");
}, 700);
cookieAccept.addEventListener("click", function() {
	localStorage.setItem("ad-cookie-accepted", "1");
...
revealItems.forEach(function(item, index) {
	if (!item.classList.contains("visible")) item.style.transitionDelay = Math.min(index * .08, .32) + "s";
